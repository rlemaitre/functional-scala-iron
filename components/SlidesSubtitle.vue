...
import type { Subtitles } from '../logic/types'
import { currentTTSLang, existSubtitle, isFirstTime, subtitlesConfig, isEnabled } from '../logic/subtitle'
...
<template>
  <div v-if="isEnabled && contents && contents[language] && contents[language][page] && contents[language][page][click]">
